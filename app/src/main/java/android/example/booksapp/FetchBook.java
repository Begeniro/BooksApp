...
public class FetchBook extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... strings){
        ...
        String BOOK_BASR_URL="https://www.googleapis.com/books/v1/volumes?";
        String QUERY_PARAM="q";
        Uri builtURI=Uri.parse(BOOK_BASR_URL).buildUpon()
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            String desc=null;
            int i=0;
            while (i<itemArrays.length()){
                JSONObject book=itemArrays.getJSONObject(i);
